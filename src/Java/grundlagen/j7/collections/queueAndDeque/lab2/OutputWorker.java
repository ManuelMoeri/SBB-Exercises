...
import Java.grundlagen.j7.collections.queueAndDeque.lab1.JobState;
import Java.grundlagen.j7.collections.queueAndDeque.lab1.ProcessingInterface;
import Java.grundlagen.j7.collections.queueAndDeque.lab1.Start;
    ...
    public void run() {
        ...
        while (countWaitCycle < Start.OUTPUTWORKER_STOP_AFTER_EMPTY_CYCLES) {
            try {
                ...
                if (job != null) {
                    job.setJobState(Java.grundlagen.j7.collections.queueAndDeque.lab1.JobState.IN_PROGRESS);
